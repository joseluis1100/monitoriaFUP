...
int main() {
    int capacidade, bananas, goiabas, mangas;
    scanf("%d %d %d %d", &capacidade, &bananas, &goiabas, &mangas);
    
    int total = bananas + goiabas + mangas;
    int minutos = total / capacidade;
    
    // caso o total for menor ou maior que a capacidade, isso será contabilizado nos minutos
